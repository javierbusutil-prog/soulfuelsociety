    ...
    <section className="pt-32 pb-20 px-4 sm:px-6 text-center">
      <div className="max-w-3xl mx-auto">
        <motion.h1
          ...
          className="font-display text-3xl sm:text-4xl lg:text-5xl font-semibold text-landing-navy leading-tight tracking-editorial mb-6"
        >
          <span className="whitespace-nowrap">Feed your body. Fuel your soul.</span><br />Find your people.
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
